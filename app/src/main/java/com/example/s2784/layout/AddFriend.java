...
//        });
    ...
    public void sendBarcode_returnWebPage(String code) {
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    if (responseCode == 200) {
                        Looper.prepare();
                        Toast.makeText(AddFriend.this,"條碼傳送成功",Toast.LENGTH_SHORT).show();
                        Looper.loop();
                    } else {
                        Looper.prepare();
                        Toast.makeText(AddFriend.this,"條碼傳送失敗",Toast.LENGTH_SHORT).show();
                        Looper.loop();
                    }
                }
                catch (IOException e) {
        ...
        try{
            ...
            startActivity(intent_main);
            Toast.makeText(AddFriend.this,"建議下載 chrome，可避免產生多餘分頁",Toast.LENGTH_SHORT).show();
        }
    }
